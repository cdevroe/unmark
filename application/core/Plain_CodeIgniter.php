 ...
 */
    ...
    // Removed because it was "running" twice $RTR->_set_routing();
 ...
 */
    ...
    foreach ($plain_controllers as $plain_file) {
        if (file_exists($plain_file)) {
            $plain_controller = $plain_file;
            break;
        }
    }
    ...
    if (empty($plain_controller)) {
        show_error('Unable to load your default controller. Please make sure the controller specified in your Routes.php file is valid.');
        $plain_controller = $plain_controllers[1];
    }

    include $plain_controller;
 ...
 * ------------------------------------------------------
 */
    $EXT->call_hook('pre_controller_method');    
