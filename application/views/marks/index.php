...
<div class="marks continue-search no-results"><?php echo sprintf( _('Would you like to <a href="<?php echo config_item('base_url') ?>marks/archive/search?q=%s">try searching your archive</a>?'), (isset($_GET['q'])) ? $_GET['q'] : ''); ?></div>
<?php elseif ($lookup_type == 'tag') : ?>
<div class="marks continue-search no-results"><?php echo sprintf( _('Would you like to <a href="<?php echo config_item('base_url') ?>marks/archive/search?q=%s">try searching your archive</a>?'), $active_tag['tag_name']); ?></div>
<?php endif; ?>
<?php else : ?>
    ...
    <div class="marks_list">
        <?php if (isset($marks)) : ?>
            ...
            <?php if (isset($_GET['q']) && $lookup_type == "search" || $lookup_type == "tag" ) : ?>
                <div class="marks continue-search with-results"><?php echo sprintf( _('Would you like to <a href="<?php echo config_item('base_url') ?>marks/archive/search?q=%s">try searching your archive</a>?'), (isset($_GET['q'])) ? $_GET['q'] : $tag_name); ?></div>
            <?php endif; ?>
        <?php else : ?>
