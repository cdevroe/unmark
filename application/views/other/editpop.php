...
<div class="main-content">
	...
	<?php } ?>
	<p><a href="<?php if (isset($markadded)) { echo 'javascript:window.close();'; } else { echo '/home'; } ?>" class="btn active">Save and close</a> <a href="/marks/delete/<?php echo $urlid;?>" class="btn danger">Delete</a></p>
	<hr />
	...
	<h3>Actions</h3>
	<p><a href="#" class="btn addlabel<?php if ($tags == 'read') { echo ' active'; } ?>" title="Read">Read</a> <a href="#" class="btn addlabel<?php if ($tags == 'watch') { echo ' active'; } ?>" title="Watch">Watch</a> <a href="#" class="btn addlabel<?php if ($tags == 'listen') { echo ' active'; } ?>" title="Listen">Listen</a></p>
	<p><a href="#" class="btn addlabel<?php if ($tags == 'buy') { echo ' active'; }?>" title="Buy">Buy</a> <a href="#" class="btn addlabel<?php if ($tags == 'eatdrink') { echo ' active'; }?>" title="Eatdrink">Eat & Drink</a> <a href="#" class="btn addlabel<?php if ($tags == 'do') { echo ' active'; } ?>" title="Do">Do</a></p>
...
<a href="#" class="btn addgroup<?php if ($groupid == $gb['id']) { echo ' active'; } ?>" title="<?php echo $gb['name'];?>" data-group="<?php echo $gb['id'];?>"><?php echo $gb['name'];?></a>
<?php } ?>
</p> <?php } ?>
