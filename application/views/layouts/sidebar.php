    ...
    <div class="sidebar-block">
        <div class="sidebar-inner">
            ...
            <p class="clear sidenote">To add Marks, drag this button into your bookmark toolbar.
                <br /> Checkout our <a href="https://chrome.google.com/webstore/detail/unmark/cdhnljlbeehjgddokagghpfgahhlifch" target="_blank">Chrome Extension</a> or to see more tools in <a href="http://help.unmark.it/bookmarklet" target="_blank">our help docs.</a></p>
        </div>
    </div>
