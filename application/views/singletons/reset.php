...
<div class="resetWrapper">
    <div class="loginInner">
        ...
        <form id="unmarkReset" method="post" action="<?php echo config_item('base_url') ?>login">
        ...
        <div class="gethere">
            ...
            <a class="help" href="http://help.unmark.it"><?php echo _('HELP'); ?></a><a class="home" href="<?php echo config_item('base_url') ?>"><?php echo _('UNMARK.IT'); ?></a>
        </div>
    </div>
</div>
