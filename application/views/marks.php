...
//		print_r($mark);
		  ...
		  <div id="mark-<?php echo $mark['usersmarkid'];?>" class="row-fluid mark<?php echo $restored;?> xfolkentry">
		    ...
		    <div class="markmeta span10">
		      <h3 id="mark-<?php echo $mark['usersmarkid'];?>"><?php if ($mark['oembed'] != '' && $mark['oembed'] != 'None' || ($mark['recipe'] != '' && $mark['recipe'] != 'None')) { ?><a class="preview-button" data-mark="<?php echo $mark['usersmarkid']?>" href="#preview-<?php echo $mark['usersmarkid'];?>" title="Preview <?php echo $mark['title'];?>"><i class="icon-zoom-in"></i></a><?php } ?><?php if (strpos($mark['url'],'.jpg') !== FALSE || strpos($mark['url'],'.jpeg') !== FALSE || strpos($mark['url'],'.png') !== FALSE) { ?><a class="preview-button" data-mark="<?php echo $mark['usersmarkid']?>" href="#preview-<?php echo $mark['usersmarkid'];?>" title="Preview <?php echo $mark['title'];?>"><i class="icon-picture"></i></a><?php } ?> <?php if ($mark['groups'] != '0') { ?><a href="/groups/<?php echo strtoupper($mark['uid']);?>" class="label label-inverse"><?php echo ucfirst($mark['name']);?></a> <?php } ?> <a href="<?php echo $mark['url'];?>" title="<?php echo $mark['title'];?>" target="_blank" class="taggedlink"><?php
		  if ($mark['title'] !='') {
