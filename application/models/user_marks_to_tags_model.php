...
class User_Marks_To_Tags_model extends Plain_Model
{
    ...
    private function getTagList($user_id, $limit=10, $type)
    {
        ...
        $tags = $this->checkForHit("
            ...
            INNER JOIN `users_to_marks` ON users_to_marks.users_to_mark_id = user_marks_to_tags.users_to_mark_id AND users_to_marks.archived IS NULL AND users_to_marks.active = '1'
